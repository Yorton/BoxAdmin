...
namespace BoxAdmin.Infrastructure.Contexts
{
    public class BoxContext : DbContext, IBoxDbContext
    {
        ...
        public virtual DbSet<MarketingActivities> MarketingActivities { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AbandonedCart>(entity =>
            {
                ...
                entity.Property(e => e.ModifityDateTime)
            ...
            modelBuilder.Entity<AbandonedCartDetail>(entity =>
            {
                ...
                entity.Property(e => e.Type).HasComment("0=一般車,1=預購車");
            ...
            modelBuilder.Entity<Account>(entity =>
            {
                ...
                entity.Property(e => e.Type)
                    ...
                    .HasComment("0:Email, 1:FB, 2:LINE, 3:APPLE");
            ...
            modelBuilder.Entity<MarketingActivities>(entity =>
            {
                entity.Property(e => e.Id)
                    .HasDefaultValueSql("(newid())")
                    .HasComment("");
            ...
            modelBuilder.Entity<MatchmakerInfo>(entity =>
            {
                ...
                entity.Property(e => e.SignatureUrl).HasComment("簽名檔URL");
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.Property(e => e.SourceTransactionNo).HasDefaultValueSql("(0x)");
            ...
            modelBuilder.Entity<ShipmentOrderItem>(entity =>
            {
                ...
                entity.Property(e => e.Id).HasComment("出貨訂單明細Id(自動流水號)");
            ...
            modelBuilder.Entity<OrderPayType>(entity =>
            {
                ...
                entity.HasComment("訂單支付方式");

                entity.Property(e => e.Id).IsRequired().HasComment("訂單支付方式ID");
