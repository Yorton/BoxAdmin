...
namespace BoxAdmin.Application.Features.Coupons.Queries.GetCouponById
{
    public class GetCouponByIdResponse
    {
        ...
        /// 指定發送時間點名稱
        /// </summary>
        [SwaggerParameter(Description = "指定發送時間點名稱")]
        public string SendTimePointName { get; set; }
        ...
        /// 可用時間選項名稱
        /// </summary>
        [SwaggerParameter(Description = "可用時間選項名稱")]
        public string CanUseTypeName { get; set; }
        ...
        /// <summary>
        ///產出類型- 1.即時產出 2.預先產出 需要搭配 總數限量 欄位
        /// </summary>
        ...
        ///產出類型名稱
        /// </summary>
        [SwaggerParameter(Description = "產出類型名稱")]
